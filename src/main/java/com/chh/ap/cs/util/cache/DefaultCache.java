...
import com.chh.ap.cs.util.LinkedListNode;
...
public class DefaultCache<K, V> implements Cache<K, V> {
    ...
    public DefaultCache(String name, long maxSize, long maxLifetime) {
        ...
        lastAccessedList = new com.chh.ap.cs.util.LinkedList<K>();
        ageList = new com.chh.ap.cs.util.LinkedList<K>();
    }
