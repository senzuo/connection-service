...
import static com.chh.ap.cs.util.StrUtil.isBlank;
...
public final class JSONUtil {
    ...
    public static <T> T toBean(JSONObject jsonObj, Class<T> beanClass) {
        BeanUtil.requireNonNull(jsonObj, "jsonObj is null");
        jsonObj.put(JSON.DEFAULT_TYPE_KEY, beanClass.getName());
        return JSON.toJavaObject(jsonObj, beanClass);
    }
    ...
    public static String toJson(List<Object> list) {
        BeanUtil.requireNonNull(list, "list is null");
